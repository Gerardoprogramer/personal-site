...
export const HeroActions = () => {
    return (
        <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:gap-4">
            <a
                href="#contacto"
                className="group inline-flex h-12 items-center justify-center gap-2 rounded-md bg-primary px-6 font-mono-tech text-sm font-semibold text-primary-foreground transition-all hover:brightness-110"
